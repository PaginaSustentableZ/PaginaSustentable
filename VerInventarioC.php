...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="VerInventarioB.php">Producto 3</a>
    </nav>
    ...
    <main class="contenedor">
        ...
        <table>
            ...
            $consulta = "SELECT talla_playera_b, cantidad_playera_b, precio_playera_b FROM inventario3";
            $resultado = mysqli_query($conexion, $consulta);

            // Imprimir filas de la tabla
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>";
                echo "<td>" . $fila['talla_playera_b'] . "</td>";
                echo "<td>" . $fila['cantidad_playera_b'] . "</td>";
                echo "<td>" . $fila['precio_playera_b'] . "</td>";
                echo "</tr>";
            }
