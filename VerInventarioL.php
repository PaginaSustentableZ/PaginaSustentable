...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="VerInventarioB.php">Producto 12</a>
    </nav>
    ...
    <main class="contenedor">
        ...
        <table>
            ...
            $consulta = "SELECT talla_playera_k, cantidad_playera_k, precio_playera_k FROM inventario12";
            $resultado = mysqli_query($conexion, $consulta);

            // Imprimir filas de la tabla
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>";
                echo "<td>" . $fila['talla_playera_k'] . "</td>";
                echo "<td>" . $fila['cantidad_playera_k'] . "</td>";
                echo "<td>" . $fila['precio_playera_k'] . "</td>";
                echo "</tr>";
            }
