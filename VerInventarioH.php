...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="VerInventarioB.php">Producto 8</a>
    </nav>
    ...
    <main class="contenedor">
        ...
        <table>
            ...
            $consulta = "SELECT talla_playera_g, cantidad_playera_g, precio_playera_g FROM inventario8";
            $resultado = mysqli_query($conexion, $consulta);

            // Imprimir filas de la tabla
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>";
                echo "<td>" . $fila['talla_playera_g'] . "</td>";
                echo "<td>" . $fila['cantidad_playera_g'] . "</td>";
                echo "<td>" . $fila['precio_playera_g'] . "</td>";
                echo "</tr>";
            }
