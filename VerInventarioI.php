...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="VerInventarioB.php">Producto 9</a>
    </nav>
    ...
    <main class="contenedor">
        ...
        <table>
            ...
            $consulta = "SELECT talla_playera_h, cantidad_playera_h, precio_playera_h FROM inventario9";
            $resultado = mysqli_query($conexion, $consulta);

            // Imprimir filas de la tabla
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>";
                echo "<td>" . $fila['talla_playera_h'] . "</td>";
                echo "<td>" . $fila['cantidad_playera_h'] . "</td>";
                echo "<td>" . $fila['precio_playera_h'] . "</td>";
                echo "</tr>";
            }
