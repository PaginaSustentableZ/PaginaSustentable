...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="VerInventarioB.php">Producto 10</a>
    </nav>
    ...
    <main class="contenedor">
        ...
        <table>
            ...
            $consulta = "SELECT talla_playera_i, cantidad_playera_i, precio_playera_i FROM inventario10";
            $resultado = mysqli_query($conexion, $consulta);

            // Imprimir filas de la tabla
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>";
                echo "<td>" . $fila['talla_playera_i'] . "</td>";
                echo "<td>" . $fila['cantidad_playera_i'] . "</td>";
                echo "<td>" . $fila['precio_playera_i'] . "</td>";
                echo "</tr>";
            }
