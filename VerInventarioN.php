...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="VerInventarioB.php">Producto 14</a>
    </nav>
    ...
    <main class="contenedor">
        ...
        <table>
            ...
            $consulta = "SELECT talla_playera_n, cantidad_playera_n, precio_playera_n FROM inventario14";
            $resultado = mysqli_query($conexion, $consulta);

            // Imprimir filas de la tabla
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>";
                echo "<td>" . $fila['talla_playera_n'] . "</td>";
                echo "<td>" . $fila['cantidad_playera_n'] . "</td>";
                echo "<td>" . $fila['precio_playera_n'] . "</td>";
                echo "</tr>";
            }
