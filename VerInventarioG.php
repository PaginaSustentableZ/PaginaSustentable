...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="VerInventarioB.php">Producto 7</a>
    </nav>
    ...
    <main class="contenedor">
        ...
        <table>
            ...
            $consulta = "SELECT talla_playera_f, cantidad_playera_f, precio_playera_f FROM inventario7";
            $resultado = mysqli_query($conexion, $consulta);

            // Imprimir filas de la tabla
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>";
                echo "<td>" . $fila['talla_playera_f'] . "</td>";
                echo "<td>" . $fila['cantidad_playera_f'] . "</td>";
                echo "<td>" . $fila['precio_playera_f'] . "</td>";
                echo "</tr>";
            }
