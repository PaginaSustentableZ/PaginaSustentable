...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="VerInventarioB.php">Producto 6</a>
    </nav>
    ...
    <main class="contenedor">
        ...
        <table>
            ...
            $consulta = "SELECT talla_playera_e, cantidad_playera_e, precio_playera_e FROM inventario6";
            $resultado = mysqli_query($conexion, $consulta);

            // Imprimir filas de la tabla
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>";
                echo "<td>" . $fila['talla_playera_e'] . "</td>";
                echo "<td>" . $fila['cantidad_playera_e'] . "</td>";
                echo "<td>" . $fila['precio_playera_e'] . "</td>";
                echo "</tr>";
            }
