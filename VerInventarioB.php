...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="VerInventarioB.php">Producto 2</a>
    </nav>
    ...
    <main class="contenedor">
        ...
        <table>
            ...
            $consulta = "SELECT talla_playera_a, cantidad_playera_a, precio_playera_a FROM inventario2";
            $resultado = mysqli_query($conexion, $consulta);

            // Imprimir filas de la tabla
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>";
                echo "<td>" . $fila['talla_playera_a'] . "</td>";
                echo "<td>" . $fila['cantidad_playera_a'] . "</td>";
                echo "<td>" . $fila['precio_playera_a'] . "</td>";
                echo "</tr>";
            }
