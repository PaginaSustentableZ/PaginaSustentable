...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="VerRegistro.php">Clientes</a>
    ...
    <main class="contenedor">
        ...
        <table>
            ...
            $consulta = "SELECT id, usuario, contraseña, direccion, correo, telefono, dinero FROM usuarios";
            ...
            <form action="eliminarUsuario.php" method="POST">
                <p>ESCRIBA EL CODIGO DEL CLIENTE AL QUE DESEA ELIMINAR:</p>
