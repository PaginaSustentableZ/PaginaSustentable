...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="VerInventarioB.php">Producto 4</a>
    </nav>
    ...
    <main class="contenedor">
        ...
        <table>
            ...
            $consulta = "SELECT talla_playera_c, cantidad_playera_c, precio_playera_c FROM inventario4";
            $resultado = mysqli_query($conexion, $consulta);

            // Imprimir filas de la tabla
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>";
                echo "<td>" . $fila['talla_playera_c'] . "</td>";
                echo "<td>" . $fila['cantidad_playera_c'] . "</td>";
                echo "<td>" . $fila['precio_playera_c'] . "</td>";
                echo "</tr>";
            }
