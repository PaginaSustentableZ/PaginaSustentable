...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="VerInventarioA.php">Producto 1</a>
    </nav>
    ...
    <main class="contenedor">
        ...
        <table>
            ...
            $consulta = "SELECT talla_playera, cantidad_playera, precio_playera FROM inventario";
            $resultado = mysqli_query($conexion, $consulta);

            // Imprimir filas de la tabla
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>";
                echo "<td>" . $fila['talla_playera'] . "</td>";
                echo "<td>" . $fila['cantidad_playera'] . "</td>";
                echo "<td>" . $fila['precio_playera'] . "</td>";
                echo "</tr>";
            }
