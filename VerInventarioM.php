...
<body>
    ...
    <nav class="navegacion">
        ...
        <a class="navegacion__enlace navegacion__enlace--activo" href="VerInventarioB.php">Producto 13</a>
    </nav>
    ...
    <main class="contenedor">
        ...
        <table>
            ...
            $consulta = "SELECT talla_playera_m, cantidad_playera_m, precio_playera_m FROM inventario13";
            $resultado = mysqli_query($conexion, $consulta);

            // Imprimir filas de la tabla
            while ($fila = mysqli_fetch_assoc($resultado)) {
                echo "<tr>";
                echo "<td>" . $fila['talla_playera_m'] . "</td>";
                echo "<td>" . $fila['cantidad_playera_m'] . "</td>";
                echo "<td>" . $fila['precio_playera_m'] . "</td>";
                echo "</tr>";
            }
